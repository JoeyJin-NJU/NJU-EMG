      ...
      '<div style="margin-top: 20px;">' +
        '<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background: rgba(255, 255, 255, 0.08); backdrop-filter: blur(25px); border-radius: 18px; border: 1px solid rgba(255, 255, 255, 0.15); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1);">' +
          ...
          '<tr>' +
            ...
            '<td width="13%" style="text-align: center; padding: 18px 8px;"><strong><a href="../GroupPageColumn/reseaches.html" style="font-size: 20px; color: #f8f9fa; font-weight: 700; transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2); letter-spacing: 0.3px; position: relative; display: inline-block;" onmouseover="this.style.color=\'#ff6b6b\'; this.style.transform=\'translateY(-3px)\'; this.style.textShadow=\'0 4px 12px rgba(255, 107, 107, 0.5)\'" onmouseout="this.style.color=\'#f8f9fa\'; this.style.transform=\'translateY(0)\'; this.style.textShadow=\'0 2px 4px rgba(0, 0, 0, 0.2)\'">研究领域</a></strong></td>' +
            '<td width="13%" style="text-align: center; padding: 18px 8px;"><strong><a href="../GroupPageColumn/members.html" style="font-size: 20px; color: #f8f9fa; font-weight: 700; transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2); letter-spacing: 0.3px; position: relative; display: inline-block;" onmouseover="this.style.color=\'#ff6b6b\'; this.style.transform=\'translateY(-3px)\'; this.style.textShadow=\'0 4px 12px rgba(255, 107, 107, 0.5)\'" onmouseout="this.style.color=\'#f8f9fa\'; this.style.transform=\'translateY(0)\'; this.style.textShadow=\'0 2px 4px rgba(0, 0, 0, 0.2)\'">团队成员</a></strong></td>' +
            '<td width="13%" style="text-align: center; padding: 18px 8px;"><strong><a href="../GroupPageColumn/publications.html" style="font-size: 20px; color: #f8f9fa; font-weight: 700; transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2); letter-spacing: 0.3px; position: relative; display: inline-block;" onmouseover="this.style.color=\'#ff6b6b\'; this.style.transform=\'translateY(-3px)\'; this.style.textShadow=\'0 4px 12px rgba(255, 107, 107, 0.5)\'" onmouseout="this.style.color=\'#f8f9fa\'; this.style.transform=\'translateY(0)\'; this.style.textShadow=\'0 2px 4px rgba(0, 0, 0, 0.2)\'">发表论文</a></strong></td>' +
	  	    '<td width="13%" style="text-align: center; padding: 18px 8px;"><strong><a href="platform.html" style="font-size: 20px; color: #ff6b6b; font-weight: 700; transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); text-shadow: 0 4px 12px rgba(255, 107, 107, 0.5); letter-spacing: 0.3px; position: relative; display: inline-block;">电镜中心</a></strong></td>' +
            '<td width="13%" style="text-align: center; padding: 18px 8px;"><strong><a href="../GroupPageColumn/news.html" style="font-size: 20px; color: #f8f9fa; font-weight: 700; transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2); letter-spacing: 0.3px; position: relative; display: inline-block;" onmouseover="this.style.color=\'#ff6b6b\'; this.style.transform=\'translateY(-3px)\'; this.style.textShadow=\'0 4px 12px rgba(255, 107, 107, 0.5)\'" onmouseout="this.style.color=\'#f8f9fa\'; this.style.transform=\'translateY(0)\'; this.style.textShadow=\'0 2px 4px rgba(0, 0, 0, 0.2)\'">新闻速递</a></strong></td>' +
            '<td width="13%" style="text-align: center; padding: 18px 8px;"><strong><a href="../GroupPageColumn/education.html" style="font-size: 20px; color: #f8f9fa; font-weight: 700; transition: all 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94); text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2); letter-spacing: 0.3px; position: relative; display: inline-block;" onmouseover="this.style.color=\'#ff6b6b\'; this.style.transform=\'translateY(-3px)\'; this.style.textShadow=\'0 4px 12px rgba(255, 107, 107, 0.5)\'" onmouseout="this.style.color=\'#f8f9fa\'; this.style.transform=\'translateY(0)\'; this.style.textShadow=\'0 2px 4px rgba(0, 0, 0, 0.2)\'">人才培养</a></strong></td>' +
            '<td width="4%">&nbsp;</td>' +
          '</tr>' +
          '<tr>' +
            '<td width="4%" height="15"></td>' +
